...
export default function OrderConfirmationClient({ order, error }: OrderConfirmationClientProps) {
  if (error || !order) {
    return (
  ...
  return (
    <div className="w-full bg-[var(--bg,#F2EDE4)] min-h-[75vh] py-8">
      <Breadcrumb items={[{ label: 'Ritual Kits', href: '/ritual-kits' }, { label: 'Order Confirmation' }]} />
